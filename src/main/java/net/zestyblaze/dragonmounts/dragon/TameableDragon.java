...
import net.zestyblaze.dragonmounts.DMLClient;
...
import net.zestyblaze.dragonmounts.client.DragonAnimator;
import net.zestyblaze.dragonmounts.data.BreedManager;
import net.zestyblaze.dragonmounts.dragon.ai.DragonBodyController;
import net.zestyblaze.dragonmounts.dragon.ai.DragonBreedGoal;
import net.zestyblaze.dragonmounts.dragon.ai.DragonMoveController;
...
public class TameableDragon extends TamableAnimal implements Saddleable, FlyingAnimal, PlayerRideable {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
                ...
                .add(Attributes.ATTACK_DAMAGE, BASE_FOLLOW_RANGE)
                .add(Attributes.KNOCKBACK_RESISTANCE, BASE_KB_RESISTANCE)
    ...
    // TODO: Much Smarter AI and features
    ...
    public void tick() {
        ...
        if (isServer()) {
            ...
            if (flying != isFlying()) {
                ...
                // new PathNavigate!)
                getAttribute(Attributes.FOLLOW_RANGE).setBaseValue(flying? BASE_FOLLOW_RANGE_FLYING : BASE_FOLLOW_RANGE);
    ...
    public void travel(Vec3 vec3) {
        ...
        if (canBeControlledByRider()) {
            // Were being controlled; override ai movement
            ...
            if (isControlledByLocalInstance()) {
                ...
                // other clients recieve animations
    ...
    protected void playStepSound(BlockPos entityPos, BlockState state) {
        ...
        if (level.getBlockState(entityPos.above()).getBlock() == Blocks.SNOW)
            //This was a Forge exclusive patch, gotta use the vanilla version
    ...
    public boolean doHurtTarget(Entity entityIn) {
        boolean attacked = entityIn.hurt(DamageSource.mobAttack(this), (float) getAttribute(Attributes.ATTACK_DAMAGE).getValue());
    ...
    private void updateAgeProperties() {
        ...
        for (var attribute : new Attribute[]{Attributes.MAX_HEALTH, Attributes.ATTACK_DAMAGE}) {
            // avoid duped code
    ...
    protected void onChangedBlock(BlockPos pos) {
        ...
        for (Ability ability : getBreed().abilities()) ability.onMove(this);
    }
}
