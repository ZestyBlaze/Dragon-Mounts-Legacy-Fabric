...
//        wiggleTime = LerpedFloat.unit();
    ...
    {
        return Component.translatable(DMLRegistry.EGG_BLOCK.getDescriptionId(), Component.translatable(breed.getTranslationKey()));
    }
    ...
    public void tick()
    {
        ...
        {
            // Update habitat
            if (DMLConfig.UPDATE_HABITATS && hatchTime > BREED_TRANSITION_TIME && !transitioner.isRunning() && tickCount % HABITAT_UPDATE_INTERVAL == 0)
                updateHabitat();
